...
$site_title = 'Cocina De Molina';
$document_title = $page_title . ' | ' . $site_title; // Home | Cocina De Molina
...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="<?php echo site_url(); ?>/dist/images/icon.png">
